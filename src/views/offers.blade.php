...
@section('content')
  <div class="hero">
    ...
    <h2 class="hero__title">Our Offers</h2>
    <div class="hero__page">
      <a class="hero__page__link" href="../index.html">Home</a> |
      <a class="hero__page__link hero__page__link-active" href="rooms.html">Offers</a>
    </div>
  </div>
  ...
  <div class="popular-rooms-wrapper">
    <section class="popular-rooms">
      <p class="popular-rooms__intro">POPULAR LIST</p>
      ...
      <div class="swiper related-rooms__swiper">
        <div class="swiper-wrapper">
          <div class="rooms-flex__box swiper-slide">
            ...
            <div class="popular-rooms__card">
              <h3 class="popular-rooms__card__title">Minimal Duplex Room</h3>
              <p class="popular-rooms__card__text">Lorem ipsum dolor sit amet, consectetur adipi sicing elit, sed do eiusmod tempor.</p>
              <div class="popular-rooms__card__bottom-flex">
                <p class="popular-rooms__card__price">$345/Night</p>
                <a class="popular-rooms__card__booking" href="">Book Now</a>
              </div>
            </div>
          </div>
        ...
        <div class="related-rooms__nav-btn related-rooms__prev-btn">
          <svg width="10" height="12" viewBox="0 0 5 8" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.81877 7.63778C3.78183 7.6378 3.74525 7.63054 3.71112 7.61641C3.67698 7.60229 3.64596 7.58158 3.61983 7.55547L0.153147 4.08859C0.100421 4.03585 0.0708008 3.96433 0.0708008 3.88975C0.0708008 3.81517 0.100421 3.74365 0.153147 3.69091L3.61983 0.224032C3.64595 0.197907 3.67695 0.177181 3.71107 0.163038C3.74519 0.148894 3.78177 0.14161 3.81871 0.141602C3.85564 0.141593 3.89222 0.14886 3.92635 0.162987C3.96048 0.177114 3.99149 0.197825 4.01762 0.223938C4.04374 0.25005 4.06447 0.281053 4.07861 0.315175C4.09275 0.349298 4.10004 0.385872 4.10005 0.422809C4.10005 0.459746 4.09279 0.496324 4.07866 0.530453C4.06453 0.564582 4.04382 0.595594 4.01771 0.621719L0.749772 3.88966L4.01771 7.15759C4.05707 7.19693 4.08388 7.24705 4.09474 7.30162C4.1056 7.3562 4.10003 7.41277 4.07873 7.46418C4.05744 7.51558 4.02137 7.55952 3.97509 7.59042C3.92882 7.62132 3.87442 7.6378 3.81877 7.63778Z" fill="#111111"/>
          </svg>
        </div>
        <div class="related-rooms__nav-btn related-rooms__next-btn">
          <svg width="10" height="12" viewBox="0 0 5 8" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1.18123 7.63778C1.21817 7.63779 1.25475 7.63053 1.28888 7.61641C1.32302 7.60229 1.35404 7.58158 1.38017 7.55547L4.84685 4.08859C4.89958 4.03585 4.9292 3.96433 4.9292 3.88975C4.9292 3.81517 4.89958 3.74365 4.84685 3.69091L1.38017 0.224032C1.35405 0.197907 1.32305 0.177181 1.28893 0.163038C1.25481 0.148894 1.21823 0.14161 1.18129 0.141602C1.14436 0.141593 1.10778 0.14886 1.07365 0.162987C1.03952 0.177114 1.00851 0.197825 0.982384 0.223938C0.956259 0.25005 0.935534 0.281053 0.92139 0.315175C0.907247 0.349298 0.899962 0.385872 0.899954 0.422809C0.899945 0.459746 0.907212 0.496324 0.92134 0.530453C0.935467 0.564582 0.956178 0.595594 0.982291 0.621719L4.25023 3.88966L0.982291 7.15759C0.942931 7.19693 0.916124 7.24705 0.905262 7.30162C0.894399 7.3562 0.899969 7.41277 0.921266 7.46418C0.942564 7.51558 0.978632 7.55952 1.02491 7.59042C1.07118 7.62132 1.12558 7.6378 1.18123 7.63778Z" fill="white"/>
          </svg>
        </div>
    </section>
  </div>
